...
int main() {
	...
	int             row;
	int             col;
	conn = PQconnectdb("host=10.100.71.21 port=5432 user=201601227 password=201601227 dbname=201601227");
	...
	while(1){
	res=PQexec(conn,"set search_path to \"inventory_management_system\";");
